		...
		<div class="row s_product_inner">
			<div class="col-lg-5">
				<div class="product_slider_img">
					<div id="vertical">
						<div data-thumb="static/img/product_details/prodect_details_1.png">
							<img src="static/img/product_details/prodect_details_1.png" />
						</div>
						<div data-thumb="static/img/product_details/prodect_details_2.png">
							<img src="static/img/product_details/prodect_details_2.png" />
						</div>
						<div data-thumb="static/img/product_details/prodect_details_3.png">
							<img src="static/img/product_details/prodect_details_3.png" />
						</div>
						<div data-thumb="static/img/product_details/prodect_details_4.png">
							<img src="static/img/product_details/prodect_details_4.png" />
						</div>
					</div>
				</div>
			</div>
			<div class="col-lg-5 offset-lg-1">
				<div class="s_product_text">
					...
					<p>Mill Oil is an innovative oil filled radiator with the most
						...
						your interior look awesome, and at the same time.</p>
					<div class="card_area">
					...
					<div class="col-lg-6">
						<div class="comment_list">
							<div class="review_item">
								<div class="media">
									<div class="d-flex">
										<img src="static/img/product/single-product/review-1.png"
											alt="" />
									</div>
							...
							<div class="review_item reply">
								<div class="media">
									<div class="d-flex">
										<img src="static/img/product/single-product/review-2.png"
											alt="" />
									</div>
									<div class="media-body">
										<h4>Blake Ruiz</h4>
							...
							<div class="review_item">
								<div class="media">
									<div class="d-flex">
										<img src="static/img/product/single-product/review-3.png"
											alt="" />
									</div>
									<div class="media-body">
										<h4>Blake Ruiz</h4>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-3 col-sm-6">
				<div class="single_category_product">
					<div class="single_category_img">
						<img src="static/img/category/category_2.png" alt="">
			...
			<div class="col-lg-3 col-sm-6">
				<div class="single_category_product">
					<div class="single_category_img">
						<img src="static/img/category/category_3.png" alt="">
						<div class="category_social_icon">
							<ul>
								<li><a href="#"><i class="ti-heart"></i></a></li>
								<li><a href="#"><i class="ti-bag"></i></a></li>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="single_category_product">
					<div class="single_category_img">
						<img src="static/img/category/category_4.png" alt="">
						<div class="category_social_icon">
							<ul>
								<li><a href="#"><i class="ti-heart"></i></a></li>
								<li><a href="#"><i class="ti-bag"></i></a></li>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="single_category_product">
					<div class="single_category_img">
						<img src="static/img/category/category_5.png" alt="">
						<div class="category_social_icon">
							<ul>
								<li><a href="#"><i class="ti-heart"></i></a></li>
								<li><a href="#"><i class="ti-bag"></i></a></li>
		...
		<div class="row">
			<div class="col-lg-3 col-sm-6">
				<div class="single_shopping_details">
					...
					<h4>Free shipping</h4>
					<p>Divided face for bearing the divide unto seed winged divided
						light Forth.</p>
				</div>
			</div>
			<div class="col-lg-3 col-sm-6">
			...
			<div class="col-lg-12">
				<div class="instagram_photo_iner">
					<div class="single_instgram_photo">
						<img src="static/img/instagram/inst_1.png" alt=""> <a
							href="#"><i class="ti-instagram"></i></a>
					</div>
					<div class="single_instgram_photo">
						<img src="static/img/instagram/inst_2.png" alt=""> <a
							href="#"><i class="ti-instagram"></i></a>
					</div>
					<div class="single_instgram_photo">
						<img src="static/img/instagram/inst_3.png" alt=""> <a
							href="#"><i class="ti-instagram"></i></a>
					</div>
					<div class="single_instgram_photo">
						<img src="static/img/instagram/inst_4.png" alt=""> <a
							href="#"><i class="ti-instagram"></i></a>
					</div>
					<div class="single_instgram_photo">
						<img src="static/img/instagram/inst_5.png" alt=""> <a
							href="#"><i class="ti-instagram"></i></a>
					</div>
				</div>
			</div>
